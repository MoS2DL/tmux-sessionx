...
* There is a conflict when using `tmux` [3.2a](https://github.com/tmux/tmux/tree/3.2a) preventing the pop-up window to show. [Upgrading](https://github.com/tmux/tmux/wiki/Installing) `tmux`, e.g., to version [3.4](https://github.com/tmux/tmux/tree/3.4) fixes this issue
